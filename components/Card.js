  ...
  return (
    ...
    >
      <div
        ...
        } bg-gradient-to-r from-emerald-500 via-teal-500 to-blue-500 h-full -z-10`}
      >
        <Link href={href} aria-label={`Link to ${title}`}>
          <animated.div
            ...
            className={`${
              onlyImg && 'w-32 h-32'
            } will-change-transform overflow-hidden relative rounded-md bg-emerald-30 dark:bg-emerald-950
